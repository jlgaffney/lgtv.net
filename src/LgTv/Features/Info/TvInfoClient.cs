...
public class TvInfoClient(IConnection connection) : ITvInfoClient
{
    ...
    {
        var requestMessage = new RequestMessage(Commands.GetCurrentTime.Uri);
    ...
    {
        var requestMessage = new RequestMessage(Commands.GetSystemInfo.Uri);
        var response = await _connection.SendCommandAsync(requestMessage);
    ...
    {
        var requestMessage = new RequestMessage(Commands.GetSoftwareInfo.Uri);
        var response = await _connection.SendCommandAsync(requestMessage);
    ...
    {
        var requestMessage = new RequestMessage(Commands.GetConnectionInfo.Uri);
        var response = await _connection.SendCommandAsync(requestMessage);
    ...
    {
        var requestMessage = new RequestMessage(Commands.GetServices.Uri);
        var response = await _connection.SendCommandAsync(requestMessage);
