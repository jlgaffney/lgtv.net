...
namespace LgTv.Clients;
    ...
    public class LgTvClient : ILgTvClient
    {
        ...
        Configuration = configuration ?? throw new ArgumentNullException(nameof(configuration));
            ...
            {
                url = Configuration.Tv.ToUrl(WebSocketProtocolInsecure, WebSocketProtocolSecure);
            }
            else
            {
                // TODO Make proxy more configurable
                url = Configuration.Proxy.ToUrl(WebSocketProtocolInsecure, WebSocketProtocolSecure) + "/" +
                      Configuration.Tv.ToUrl(WebSocketProtocolInsecure, WebSocketProtocolSecure);
            }
        ...
        public async Task<ILgWebOsMouseClient> GetMouse()
        {
            ...
            if (Configuration.Proxy != null)
            {
                socketPath = Configuration.Proxy.ToUrl(WebSocketProtocolInsecure, WebSocketProtocolSecure) + "/" + socketPath;
            }
