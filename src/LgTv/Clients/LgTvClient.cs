...
namespace LgTv.Clients
{
    public class LgTvClient : ILgTvClient
    {
        ...
        private const string WebSocketProtocolInsecure = "ws";
        private const string WebSocketProtocolSecure = "wss";
        ...
        private readonly LgTvClientConfiguration _configuration;
            ...
            LgTvClientConfiguration configuration)
        {
            ...
            {
                url = _configuration.Tv.ToUrl(WebSocketProtocolInsecure, WebSocketProtocolSecure);
            }
            else
            {
                // TODO Make proxy more configurable
                url = _configuration.Proxy.ToUrl(WebSocketProtocolInsecure, WebSocketProtocolSecure) + "/" +
                      _configuration.Tv.ToUrl(WebSocketProtocolInsecure, WebSocketProtocolSecure);
            }
        ...
        public async Task<ILgWebOsMouseClient> GetMouse()
        {
            ...
            if (_configuration.Proxy != null)
            {
                socketPath = _configuration.Proxy.ToUrl(WebSocketProtocolInsecure, WebSocketProtocolSecure) + "/" + socketPath;
            }
